            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <form @submit.prevent="onSubmit" ref="payDte" enctype="multipart/form-data">
    ...
    export default {
        ...
        methods: {
            ...
            onSubmit(e) {
                ...
                axios.post('/api/dte/pay?api_token='+App.apiToken, formData, config)
                ...
                this.$refs.payDte.reset(); // This will clear that form

                this.$awn.success("El registro ha sido pagado", {labels: {success: "Éxito"}});

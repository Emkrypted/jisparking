            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <form @submit.prevent="onSubmit" ref="reviewTicket" enctype="multipart/form-data">
    ...
    export default {
        ...
        methods: {
            ...
            acceptTicket(e) {
                ...
                this.$refs.reviewTicket.reset(); // This will clear that form
            ...
            rejectTicket(e) {
                ...
                axios.post('/api/dte/reject/'+ this.$route.params.id +'?api_token='+App.apiToken, formData, config)
                .then(function (response) {
                    currentObj.success = response.data.success;
                })
                .catch(function (error) {
                ...
                this.$awn.success("El registro ha sido rechazado", {labels: {success: "Éxito"}});

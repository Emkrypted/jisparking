...
class DteTypeController extends ApiResponseController
{
    ...
    {
        $dte_types = DteType::where('visible_id', 1)->orderBy('dte_type_id', 'desc')->get();

        return $this->successResponse($dte_types);
    }
